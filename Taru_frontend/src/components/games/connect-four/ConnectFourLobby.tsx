    ...
    >
      {status === "found" ? (
        <div className="animate-fade-in py-4">
          <div className="relative inline-flex items-center justify-center w-20 h-20 mb-6 rounded-full bg-red-50 text-4xl shadow-inner">
          ...
          <div className="w-full bg-gray-100 h-1.5 rounded-full overflow-hidden">
            <div className="bg-red-600 h-full animate-pulse w-full" />
          </div>
        </div>
      ) : (
        <div className="py-4">
